...
function getDbConfig() {
  ...
  // Kalau kamu punya file CA, isi DB_SSL_CA dengan isi PEM cert (bukan path) atau set ENV dari Vercel.
  const sslCA = process.env.DB_SSL_CA; // optional (string PEM)
  const ssl =
...
// cache pool di global biar gak bikin pool baru tiap request (dev hot reload aman)
